...
export const TextRevealCard = ({
  ...
  return (
    ...
    >
      ...
      <div className="h-[40vh]  relative flex items-center overflow-hidden">
        <motion.div
          style={{
            width: "100%",
          }}
        ...
        >
          <p
            ...
            className="text-base sm:text-[3rem] h-full py-10 leading-5 font-bold text-white bg-clip-text text-transparent bg-gradient-to-b from-white to-neutral-300"
          >
            {revealText}
          </p>
        </motion.div>
...
const Stars = () => {
  ...
  return (
    <div className="absolute leading-5 h-full inset-0">
      {[...Array(80)].map((_, i) => (
        <motion.span
          key={`star-${i}`}
          animate={{
