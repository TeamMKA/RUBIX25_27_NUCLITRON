    ...
    <div className="relative w-full bg-gradient-to-b from-black via-gray-900 to-black text-yellow-300 font-serif" ref={containerRef}>
      <div className="max-w-4xl mx-auto py-16 px-4">
        ...
        <p className="text-yellow-200 text-sm md:text-lg max-w-2xl leading-relaxed">
          Journey through time to witness the transformative moments that shaped our world. This historical timeline blends
          visual aesthetics with storytelling for an immersive experience.
        </p>
      </div>

      <div ref={ref} className="relative max-w-4xl mx-auto pb-20">
        {data.map((item, index) => (
          <div key={index} className="relative flex justify-start pt-16 md:pt-24 md:gap-10">
